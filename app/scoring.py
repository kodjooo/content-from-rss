...
class RelevanceScorer:
    ...
    def _build_prompt(self, item: NewsItem) -> str:
        ...
        return (
            "Оцени, насколько эта новость дает повод для практического применения, разбора ошибок или сильного инсайта для начинающих AI-практиков и автоматизаторов без глубокого кода (n8n/Make/Python + AI-агенты), по шкале от 1 до 10.\n"
