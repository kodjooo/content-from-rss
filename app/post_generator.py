...
class PostComposer:
    ...
    def _build_prompt(self, item: NewsItem) -> str:
        ...
        return (
            ...
            "Сгенерируй две версии поста: длинную (1500–3000 символов) и короткую (до 600 символов).\n"
            ...
            "body — длинная версия поста (1500–3000 символов, без хэштегов).\n"
            ...
            "\"body\": \"Развёрнутый текст 1500–3000 символов с выделениями **жирным**...\","
