...
class PostComposer:
    ...
    def _build_prompt(self, item: NewsItem) -> str:
        ...
        return (
            ...
            "Все версии должны быть аналитическими, с акцентом на практические выводы для IT-специалистов или владельцев бизнеса (нужно проанализировать для кого эта новость имеет большие последствия и именно о них написать, не одновременно для IT-специалистов или владельцев бизнеса, а только для кого-то одного).\n\n"
